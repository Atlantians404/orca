...
def calculate_all_results(agent_data):
    ...
    for pfz_id, time_data in agent_data.items():
...
def rank_pfz_by_average(results):
    ...
    for result in results:
        ...
        pfz_id = result["pfz_id"]

        if pfz_id not in pfz_scores:

            pfz_scores[pfz_id] = []

        pfz_scores[pfz_id].append(
            result["risk_score"]
        )

    pfz_average = []

    for pfz_id, scores in pfz_scores.items():
...
def run_risk_engine(data):
    ...
    # 1 PFZ + multiple times
    #
    # Return all requested times ranked.
    # ========================================================
    ...
    # = 60 calculations
    #
    # Rank PFZs using average risk.
    #
    # Return Top 5 PFZs.
    # Each PFZ contains ALL 3 times.
    # ========================================================
